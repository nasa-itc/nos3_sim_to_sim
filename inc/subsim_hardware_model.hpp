#ifndef NOS3_SUBSIMHARDWAREMODEL_HPP
#define NOS3_SUBSIMHARDWAREMODEL_HPP
...
** Defines
*/
#define SUBSIM_SIM_SUCCESS 0
#define SUBSIM_SIM_ERROR   1
...
namespace Nos3
{
    ...
    class SubsimHardwareModel : public SimIHardwareModel
    {
    public:
        /* Constructor and destructor */
        SubsimHardwareModel(const boost::property_tree::ptree& config);
        ~SubsimHardwareModel(void);

    private:
        /* Private helper methods */
        void create_subsim_hk(std::vector<uint8_t>& out_data); 
        void create_subsim_data(std::vector<uint8_t>& out_data); 
        ...
        SimIDataProvider*                                   _subsim_dp; /* Only needed if the sim has a data provider */
